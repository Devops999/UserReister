...
public class RegisterTestContainer extends TestContainer {

    public RegisterTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/register/app.properties",
    ...
    public static class Common extends RegisterTestContainer {

        public static final RegisterTestContainer.Common INSTANCE = new RegisterTestContainer.Common();
